...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">Đăng ký Môn Học</div>
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{route('Dangkymon.store')}}">
                        @csrf
                      ...
                      <button type="submit" class="btn btn-primary">Đăng ký </button>
                         ...
                         <a class="btn btn-success" href="{{route('Dangkymon.index')}}">Danh sách ĐĂng kí</a>
